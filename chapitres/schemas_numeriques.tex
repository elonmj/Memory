...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{images/schemas_numeriques/onde_choc_simple}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{images/schemas_numeriques/interaction_multiclasse}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{images/schemas_numeriques/discontinuite_revetement}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{images/schemas_numeriques/intersection}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{images/schemas_numeriques/carrefour_stade}
